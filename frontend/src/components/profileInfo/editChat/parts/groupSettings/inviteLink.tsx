...
const InviteLink: FC<InviteLinkProps> = ({ typeSetting, setTypeSetting, groupTypeRef, contentProtectionRef }) => {
    ...
    return (
        <div>
            ...
            {
                dropDownValue === 'public'
                    ? <p className="px-[25px] py-[10px] text-gray-500 text-sm">if you set ap public link, other people will be able to find and join your group.</p>
                    : <p className="px-[25px] py-[10px] text-gray-500 text-sm">People can join your group by following this link. You can revoke the link an any time.</p>
            }
