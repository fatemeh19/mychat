...
const ChatHeader: FC<ChatHeaderProps> = ({ infoState, setInfoVState }) => {
    ...
    return (
        <div>
                                ...
                                >
                                    <div className="profile">
                                        <Image
                                            width={500}
                                            height={500}
                                            src={userContact.profilePic ? profilePicHandler(userContact) : '/defaults/defaultProfilePic.png'}
                                            alt='chat profile'
            ...
            <ConfirmModal showConfirm={showConfirm} setShowConfirm={setShowConfirm} open={open} setOpen={setOpen} confirmHandler={deleteHandler_multipleMessage} confirmInfo={confirmInfo} confirmButtonText='Delete messages' />
            {forwardPopupOpen
                ? <CustomizedDialogs
